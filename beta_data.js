...
window.phraseDict = [
    ...
    ["關閉 (不回報)", "关闭 (不回报)"], ["📧 寄出錯誤報告", "📧 寄出错误报告"], ["時間", "时间"], ["錯誤", "错误"], ["位置", "位置"], ["設備", "设备"],

    // ==========================================
    // 💡 8. 最新版 (V4.7.5) 雙軌指南與硬核原理解析
    // ==========================================
    ["📖 歡迎使用！點此查看「角色與排軸設定」指南", "📖 欢迎使用！点此查看「角色与排轴设定」指南"],
    ["🟢 簡明版 (快速上手)", "🟢 简明版 (快速上手)"], ["🔍 詳細版 (模塊原理解析)", "🔍 详细版 (模块原理解析)"],
    ["【三步完成基礎設定】", "【三步完成基础设定】"], ["【快捷按鈕與功能】", "【快捷按钮与功能】"],
    ["【角色勾選與快捷過濾】", "【角色勾选与快捷过滤】"], ["【排軸難度與自訂功能】", "【排轴难度与自订功能】"], ["【🎯 達成率拉桿與穩定性計算】", "【🎯 达成率拉杆与稳定性计算】"],
    ["📖 操作指南：實戰編隊與推演功能 (點擊展開)", "📖 操作指南：实战编队与推演功能 (点击展开)"],
    ["【兩大推演模式】", "【两大推演模式】"], ["【沙盤快捷按鈕與功能】", "【沙盘快捷按钮与功能】"],
    ["【⚙️ 雙軌推演模式 (環境設定)】", "【⚙️ 双轨推演模式 (环境设定)】"], ["【🔄 實戰反推與無損洗牌 (硬核最佳化)】", "【🔄 实战反推与无损洗牌 (硬核最佳化)】"], ["【🧮 代數反解與王血量校正】", "【🧮 代数反解与王血量校正】"],
    ["【🧮 隱藏功能：代數反解與王血量校正】", "【🧮 隐藏功能：代数反解与王血量校正】"],
    ...
    ["➕ 新增自訂：", "➕ 新增自订："], ["手動創建專屬排軸，設定主C、副C與預設 DPS。", "手动创建专属排轴，设定主C、副C与预设 DPS。"],
    ["🎯 達成率拉桿：", "🎯 达成率拉杆："], ["依照您的操作熟練度設定折損比例，系統會自動下修實戰預估傷害。", "依照您的操作熟练度设定折损比例，系统会自动下修实战预估伤害。"],
    ["⏱️ 穩定性計算器：", "⏱️ 稳定性计算器："], ["輸入實測打王耗時，由系統幫您精算出真實達成率。", "输入实测打王耗时，由系统帮您精算出真实达成率。"],
    ["模式一 (抄作業)：", "模式一 (抄作业)："], ["點擊「🔥 一鍵極限編制」，系統會自動滿編目前最高總分的隊伍。", "点击「🔥 一键极限编制」，系统会自动满编目前最高总分的队伍。"],
    ["模式二 (優化現有)：", "模式二 (优化现有)："], ["排好出戰隊伍並填寫「實戰得分」。接著點擊「🔄 無損洗牌反推」，系統會自動排序最佳出戰順序！", "排好出战队伍并填写「实战得分」。接着点击「🔄 无损洗牌反推」，系统会自动排序最佳出战顺序！"],
    ["⚙️ 雙軌模式切換：", "⚙️ 双轨模式切换："], ["在「環境設定」內可隨時切換「🔥自動推演」與「🗺️手動編隊」。", "在「环境设定」内可随时切换「🔥自动推演」与「🗺️手动编队」。"],
    ["⚡ 快速填入：", "⚡ 快速填入："], ["利用沙盤上方的屬性篩選，一鍵將推薦配隊填入空位。", "利用沙盘上方的属性筛选，一键将推荐配队填入空位。"],
    ["💾 記憶 / 📂 讀取：", "💾 记忆 / 📂 读取："], ["儲存您的深塔愛用陣容，隨時無縫切換。", "储存您的深塔爱用阵容，随时无缝切换。"],
    ["⚙️ 數據總管(右上角)：", "⚙️ 数据总管(右上角)："], ["管理自訂資料，產生備份代碼以實現跨裝置同步。", "管理自订资料，产生备份代码以实现跨装置同步。"],
    ["🌐 簡/繁切換 (全域)：", "🌐 简/繁切换 (全域)："], ["一鍵無縫切換繁簡中文介面。", "一键无缝切换繁简中文介面。"],

    // 詳細版原理解析 (最新長句版)
    ["運作方式：系統內建全角色的「耐力值」(一般角色 1 次，部分生存位 2 次)。您可利用上方的「🌟星級」與「世代」過濾器，或直接在「🔍 搜尋框」輸入名字快速找人。點擊「🗑️ 清空/全選」可一鍵批次操作。", "运作方式：系统内建全角色的「耐力值」(一般角色 1 次，部分生存位 2 次)。您可利用上方的「🌟星级」与「世代」过滤器，或直接在「🔍 搜寻框」输入名字快速找人。点击「🗑️ 清空/全选」可一键批次操作。"],
    ["運作方式：內建各大佬測算的理論排軸，分為 🟩輪椅 到 ⚠️極難 五個檔次。關閉特定難度後，該排軸將不會參與下一頁的推演。", "运作方式：内建各大佬测算的理论排轴，分为 🟩轮椅 到 ⚠️极难 五个档次。关闭特定难度后，该排轴将不会参与下一页的推演。"],
    ["➕ 新增自訂：允許手動綁定主C、副C、生存並賦予 DPS 與難度，永久寫入瀏覽器本機。", "➕ 新增自订：允许手动绑定主C、副C、生存并赋予 DPS 与难度，永久写入浏览器本机。"],
    ["📊 單一排軸自訂加權：點擊排軸卡片上的 [DPS數字]，可直接手動覆寫該隊的真實 DPS、穩定性，甚至設定「🌟 當期屬性增傷加權(%)」(例如本期深塔冷凝傷害+20%)。", "📊 单一排轴自订加权：点击排轴卡片上的 [DPS数字]，可直接手动覆写该队的真实 DPS、稳定性，甚至设定「🌟 当期属性增伤加权(%)」(例如本期深塔冷凝伤害+20%)。"],
    ["運算公式：各難度折損率 = 100 - (100 - 全局設定值) × 難度權重。您也可點開下方的摺疊面板，單獨對「⚠️ 極難」或「🟩 輪椅」進行微調。", "运算公式：各难度折损率 = 100 - (100 - 全局设定值) × 难度权重。您也可点开下方的折叠面板，单独对「⚠️ 极难」或「🟩 轮椅」进行微调。"],
    ["結果事例：【今汐隊】理論 DPS 為 6w (⭐進階)。若您將拉桿設為 80%，該排軸的真實達成率為", "结果事例：【今汐队】理论 DPS 为 6w (⭐进阶)。若您将拉杆设为 80%，该排轴的真实达成率为"],
    ["系統會將該隊實戰 DPS 下修為 ", "系统会将该队实战 DPS 下修为 "],
    ["，防止分數預估膨脹。", "，防止分数预估膨胀。"],
    ["⏱️ 內建軸穩定性計算器：輸入排軸的「標準耗時」與您去全像實測的 3 次「實際耗時」。系統會用標準差(σ)算出您的真實穩定度，點擊即可一鍵套用至拉桿。", "⏱️ 内建轴稳定性计算器：输入排轴的「标准耗时」与您去全像实测的 3 次「实际耗时」。系统会用标准差(σ)算出您的真实稳定度，点击即可一键套用至拉杆。"],
    ["點開「🌌 矩陣實戰接力推演與環境設定」可切換兩種核心運算模式：", "点开「🌌 矩阵实战接力推演与环境设定」可切换两种核心运算模式："],
    ["🔥 自動推演 (依DPS接力)：系統純看各隊 DPS 下限/上限，自動推算能打穿幾隻王，並給出理論總分區間。", "🔥 自动推演 (依DPS接力)：系统纯看各队 DPS 下限/上限，自动推算能打穿几只王，并给出理论总分区间。"],
    ["🗺️ 手動編隊 (殘血反算總分)：根據您在表格輸入的「🎯尾王」與「🩸剩(%)」，系統反推您該隊的預估得分。若您同時填寫了「實戰得分」，系統還會計算「📈單排置信度」，幫您抓出是否填錯或嚴重失誤。", "🗺️ 手动编队 (残血反算总分)：根据您在表格输入的「🎯尾王」与「🩸剩(%)」，系统反推您该队的预估得分。若您同时填写了「实战得分」，系统还会计算「📈单排置信度」，帮您抓出是否填错或严重失误。"],
    ["系統採用「貪婪演算法」，掃描您的角色庫與排軸，優先排滿能產生最高總 DPS 的陣容。您可透過右上角的「顯示隊伍數」下拉選單 (3~16隊)，精簡沙盤空間。", "系统采用「贪婪演算法」，扫描您的角色库与排轴，优先排满能产生最高总 DPS 的阵容。您可透过右上角的「显示队伍数」下拉选单 (3~16队)，精简沙盘空间。"],
    ["運算公式：真實 DPS = 等效總傷害 ÷ 真實戰鬥時間。系統會精準扣除您在環境設定中的「轉場耗時」與「抗性減傷」。", "运算公式：真实 DPS = 等效总伤害 ÷ 真实战斗时间。系统会精准扣除您在环境设定中的「转场耗时」与「抗性减伤」。"],
    ["結果事例：您的第一隊【忌炎隊】打出 ", "结果事例：您的第一队【忌炎队】打出 "],
    [" 分 (1000 萬總傷害)，勾選遭遇 [1] 號抗性王 (抗性50%)。假設 R1 每隻王均血 400 萬。", " 分 (1000 万总伤害)，勾选遭遇 [1] 号抗性王 (抗性50%)。假设 R1 每只王均血 400 万。"],
    ["R1-1 (400w血，50%抗性)：", "R1-1 (400w血，50%抗性)："],
    ["帳面上打掉 400w 血，但因抗性實際消耗了忌炎隊", "帐面上打掉 400w 血，但因抗性实际消耗了忌炎队"],
    ["的「等效傷害」。剩餘傷害量為 600w。", "的「等效伤害」。剩余伤害量为 600w。"],
    ["R1-2 (無抗) / R1-3 (無抗)：", "R1-2 (无抗) / R1-3 (无抗)："],
    ["打死 R1-2 消耗 400w 等效傷害。剩下的 200w 打在 R1-3 身上，剛好讓王剩下 ", "打死 R1-2 消耗 400w 等效伤害。剩下的 200w 打在 R1-3 身上，刚好让王剩下 "],
    [" 血量。", " 血量。"],
    ["【忌炎隊】的等效總傷害為", "【忌炎队】的等效总伤害为"],
    ["。戰鬥時間為", "。战斗时间为"],
    ["(2隻擊殺 × 1.5s轉場) = 117s", "(2只击杀 × 1.5s转场) = 117s"],
    ["反推真實 DPS 為 ", "反推真实 DPS 为 "],
    ["。系統會保留您的隊員，將高達 11.96w 的忌炎隊「無損洗牌」調度至後期高壓波次！", "。系统会保留您的队员，将高达 11.96w 的忌炎队「无损洗牌」调度至后期高压波次！"],
    ["🔄 重設預設 DPS：反推會自動修改該隊伍的自訂 DPS，點擊各隊生存位下方的按鈕即可清除覆寫。", "🔄 重设预设 DPS：反推会自动修改该队伍的自订 DPS，点击各队生存位下方的按钮即可清除覆写。"],
    ["結果事例：延續上題，您剩下 200w 傷害打在 R1-3 身上，但您發現遊戲裡王只剩下了 ", "结果事例：延续上题，您剩下 200w 伤害打在 R1-3 身上，但您发现游戏里王只剩下了 "],
    [" 血。您填入「🎯尾王: R1-3，🩸剩: 45%」。", " 血。您填入「🎯尾王: R1-3，🩸剩: 45%」。"],
    ["代數反解 R1-3 真實總血量 =", "代数反解 R1-3 真实总血量 ="],
    ["若系統收集滿 3 筆資料，發現算出的 363.6w 與預設的 400w 偏差超過 ", "若系统收集满 3 笔资料，发现算出的 363.6w 与预设的 400w 偏差超过 "],
    ["，下方的「進階校正面板」就會彈出「⚠️ 套用校正」按鈕。您也可以直接在該面板手動覆寫特例王的血量。", "，下方的「进阶校正面板」就会弹出「⚠️ 套用校正」按钮。您也可以直接在该面板手动覆写特例王的血量。"]
];
